...
import '../../create_event/widgets/EventType.dart';

class EditEvent extends StatefulWidget {
  static const String routeName = "edit_event";
  Event event;
  EditEvent(this.event, {super.key});

  @override
  State<EditEvent> createState() => _EditEventState();
}

class _EditEventState extends State<EditEvent> with TickerProviderStateMixin {
                          ...
                          onClick: () async {
                            if (formKey.currentState!.validate()) {
                              if (selectedDate == null || selectedTime == null) {
                                ...
                                await FirestoreManager.updateEvent(updatedEvent);
